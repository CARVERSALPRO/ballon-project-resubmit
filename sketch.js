...
function redBalloon() {
  var red = createSprite(0,Math.round(random(20, 200)), 10, 10);
...
function greenBalloon() {
  var green = createSprite(0,Math.round(random(60, 420)), 10, 10);
...
function pinkBalloon() {
  var pink = createSprite(0,Math.round(random(80, 440)), 10, 10);
